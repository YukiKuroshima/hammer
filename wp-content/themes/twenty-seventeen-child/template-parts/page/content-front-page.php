...
foreach ( $events as $post ) {
    ...
    $logo_style_text = get_logo_css_margin ( $category_text, $is_left );
        ...
        echo '<h3 class="margin-bottom-50 home-event-series"><u>'.tribe_get_text_categories().'<span style="color: var('.tribe_get_color_for_categories( tribe_get_text_categories() ).');">&#x2794;</span></u></h3>';
